...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        visited = [p == pos for p in self.corners]
        return [pos, visited]
...
def cornersHeuristic(state, problem):
    ...
    if len_uc == 1:
        ...
        if (pos, unvisited_corner) in problem.shortCutMemory.keys():
            return problem.shortCutMemory[(pos, unvisited_corner)]
        else:
            dist = mazeDistance(pos, unvisited_corner, problem.gameState)
            problem.shortCutMemory[(pos, unvisited_corner)] = dist
            return dist
